...
#     choir = er.choirs[choir_i % len(er.choirs)]
...
# The following code used to update the rhythmic settings of
#   all rhythmic unison followers. It won't work anymore because
#   there is no such attribute as "er.rhythm_lists_by_voice". But
#   in any case, I don't believe it is necessary, since rhythmic_unison
#   followers share the Rhythm instance with the leader.
...
# TODO delete
# user should give abs (i.e., already cumulative) rather than relative times
...
#     #     if er.pattern_len[pattern_i] is None:
#     #         er.pattern_len[pattern_i] = er.len_all_harmonies
...
#     #     #         (max(er.pattern_len), er.len_all_harmonies),
...
#     # All of the below "_process_rhythm_list" calls are for attributes that are
#     #   now per-voice sequences
