...
# from er_misc_funcs import pitches_consonant
...
def test_get_index():
    ...
    try:
        ...
        assert (
            voice.get_i_before(0.25) == 0
        ), "voice.get_index_before(0.25) != 0"
        assert (
            voice.get_i_before(-0.1) == -1
        ), "voice.get_index_before(-0.1) != -1"
